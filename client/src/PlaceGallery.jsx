...
export default function PlaceGallery({place}) {
            ...
            <div className='absolute inset-0 bg-black text-white min-w-full min-h-screen'>
                <div className='bg-black p-8 grid gap-4'>
                    <div>
                        ...
                        <button onClick={()=>setShowAllPhotos(false)} name='closeBtn' className='fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl shadow shadow-black text-black'>
  ...
  return (
    <div className="relative">
            <div className="shadow-md shadow-black cursor-pointer grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                <div>
                {place.photos?.[0]&&(
                    <div>
            ...
            <button onClick={()=> setShowAllPhotos(true)} name='addPhotos' className='flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow-md shadow-gray-500'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
